/**
 * Кусок кода, отправляющий аудио данные с микрофона в модель Vosk'а.
 * Его приходится выносить в отдельный файл ибо метод BaseAudioContext.createScriptProcessor, позволяющий передавать аудио-данные
 * из основного скрипта, не поддерживается (или скоро перестанет поддерживаться) современными браузерами.
 */
